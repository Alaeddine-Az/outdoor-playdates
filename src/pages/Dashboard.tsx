...
const Dashboard = () => {
  ...
  return (
    <div className="animate-fade-in px-4 py-6 max-w-6xl mx-auto">
      {/* Hero Section */}
      <section className="relative bg-[#CEEBF0] rounded-3xl overflow-hidden mb-8" style={{ height: '280px', fontFamily: '"Baloo 2", cursive' }}>
        {/* Sky Shape */}
        <div className="absolute inset-0 bg-[#CEEBF0]">
          ...
          <div className="absolute w-20 h-20 bg-[#F9DA6F] rounded-full top-8 right-8 animate-bounce-sun" />
        </div>

        {/* Green Hill */}
        <div className="absolute bottom-0 w-full h-[80px] bg-[#73C770] rounded-t-[100%]" />

        <div className="relative z-10 h-full px-6 py-8 flex flex-col justify-between">
          <div className="text-left">
            <h1 className="text-4xl font-extrabold text-black mb-2">Welcome back, {profile?.parent_name?.split(' ')[0] || 'there'}!</h1>
