  ...
  return (
    <section ref={ref as React.RefObject<HTMLDivElement>} className="relative min-h-screen flex items-center px-6 pt-16 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="text-center lg:text-left max-w-xl mx-auto lg:mx-0">
            <div className="inline-block rounded-full bg-muted mb-4 px-4 py-1.5">
          ...
          <div className={cn("relative w-full max-w-lg mx-auto lg:mx-0", isIntersecting ? "animate-scale-up" : "opacity-0")}>
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2">
        <button onClick={scrollToFeatures} aria-label="Scroll to features" className="animate-bounce flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-soft">
